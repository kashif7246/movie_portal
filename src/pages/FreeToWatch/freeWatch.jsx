...
import "./freeToWatch.module.css";

const FreeWatch = (props) => {
  const [value, setValue] = useState("movies");
  useEffect(() => {
    props?.allfreeToWatch({ categoryType: value, page: 1 });
  }, [value]);
      ...
      >
        <TabContext value={value}>
          ...
          >
            ...
            >
              <Tab label="Streaming" value="movies" />
              <Tab label="On TV" value="tv" />
            </TabList>
          </Box>
          <TabPanel value="movies">
            ...
            >
              {props?.freeWatch?.map((item, index) => (
